...
let RdsFindByIdWorkflow = class RdsFindByIdWorkflow extends base_rds_workflow_1.BaseRdsWorkflow {
    ...
    execute(id, criteria = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const entity = yield this.repository.findOne(Object.assign(Object.assign({}, parsedCriteria), { transaction, raw: true }));
            if (!entity) {
