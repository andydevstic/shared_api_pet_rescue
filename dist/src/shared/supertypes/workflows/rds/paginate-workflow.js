...
let RdsPaginateWorkflow = class RdsPaginateWorkflow extends base_rds_workflow_1.BaseRdsWorkflow {
    ...
    execute(criteria = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const findResult = yield this.repository.findAndCountAll(Object.assign(Object.assign({}, parsedCriteria), { transaction, raw: true }));
            return {
