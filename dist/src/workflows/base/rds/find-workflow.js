...
let RdsFindWorkflow = class RdsFindWorkflow {
    ...
    execute(criteria = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const entities = yield tableDataGateway.findAll(Object.assign(Object.assign({}, parsedCriteria), { transaction, raw: true }));
            return entities;
        });
    }
