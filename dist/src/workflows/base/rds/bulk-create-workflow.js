...
exports.RdsBulkCreateWorkflow = void 0;
const inversify_1 = require("inversify");
const constants_1 = require("@src.shared/shared/constants");
let RdsBulkCreateWorkflow = class RdsBulkCreateWorkflow {
    ...
    execute(data, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createdEntities = yield tableDataGateway.bulkCreate(data, { transaction });
            return createdEntities;
        });
    }
};
RdsBulkCreateWorkflow = __decorate([
    inversify_1.injectable(),
    __metadata("design:paramtypes", [Object, Object])
], RdsBulkCreateWorkflow);
exports.RdsBulkCreateWorkflow = RdsBulkCreateWorkflow;
